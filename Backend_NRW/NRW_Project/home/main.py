...
# Define a knowledge base or database of information
knowledge_base = {
...
while True:
    ...
    # Handle menu options
    if intent == "faq":
        print("Chatbot: Please select an option (1, 2, 3): if you want answer of any of them, Otherwise you can type your question.")
        user_choice = input("You: ")
        if user_choice == "1":
            print("Chatbot: Non-Revenue Water (NRW) is the water that is lost in the distribution network and not billed to customers. It includes water lost through leaks, theft, or inaccuracies in metering.")
            print("If you wanna get answer of the another question of FAQ type 'faq'.")
        elif user_choice == "2":
            print("Chatbot: NRW is calculated as the difference between the water put into the distribution system and the water recovered from consumers. It is a crucial indicator of water utility performance, efficiency, and financial sustainability.")
            print("If you wanna get answer of the another question of FAQ type 'faq'.")
        elif user_choice == "3":
            print("Chatbot: Implementing technology to reduce NRW, improving metering accuracy, and adopting sustainable practices can save water and increase profitability for water utilities.")
            print("If you wanna get answer of the another question of FAQ type 'faq'.")
        else:
            print("Chatbot: Invalid choice. Please select a valid option.")

    # Check if the intent is a greeting and automatically follow up with FAQs
    elif intent == "greeting":
        print("Chatbot: " + knowledge_base["faq"])
        print("Chatbot: Please select an option (1, 2, 3):if you want answer of any of them, Otherwise you can type your question.")
        user_choice = input("You: ")
        if user_choice == "1":
            print("Chatbot: Non-Revenue Water (NRW) is the water that is lost in the distribution network and not billed to customers. It includes water lost through leaks, theft, or inaccuracies in metering.")
